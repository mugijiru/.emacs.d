...
** 基本設定
   ...
   :EXPORT_HUGO_CUSTOM_FRONT_MATTER: :pre "1. " :weight 1
   :END:
*** 概要
...
** org-babel
   ...
   :EXPORT_HUGO_CUSTOM_FRONT_MATTER: :pre "2. " :weight 2
   :END:
*** 概要
...
** 予定のカレンダー表示
   ...
   :EXPORT_HUGO_CUSTOM_FRONT_MATTER: :pre "3. " :weight 3
   :END:
*** 概要
...
** Agenda 関係の設定
   ...
   :EXPORT_HUGO_CUSTOM_FRONT_MATTER: :pre "4. " :weight 4
   :END:
*** 概要
...
** org-capture
   ...
   :EXPORT_HUGO_CUSTOM_FRONT_MATTER: :pre "5. " :weight 5
   :END:
*** 概要
...
** org-clock
   ...
   :EXPORT_HUGO_CUSTOM_FRONT_MATTER: :pre "6. " :weight 6
   :END:
*** 概要
...
** org-export
   ...
   :EXPORT_HUGO_CUSTOM_FRONT_MATTER: :pre "7. " :weight 7
   :END:
*** 概要
...
** org-gcal                                                     :replacement:
   ...
   :EXPORT_HUGO_CUSTOM_FRONT_MATTER: :pre "8. " :weight 8
   :END:
...
** org-ql                                                            :unused:
   ...
   :EXPORT_HUGO_CUSTOM_FRONT_MATTER: :pre "9. " :weight 9
   :END:
