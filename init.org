...
#+begin_src emacs-lisp :tangle snippets/emacs-lisp-mode/recipe
# -*- mode: snippet -*-
# name: recipe
# key: recipe
# --
...
#+begin_src emacs-lisp :tangle recipes/el-get-lock.rcp
(:name el-get-lock
...
:ID:       3fcc6b51-b849-43c0-91c6-772aa1019b3d
:END:
...
#+begin_src emacs-lisp :tangle recipes/exec-path-from-shell.rcp
...
*** 設定
:PROPERTIES:
:ID:       088e28d8-0465-4e34-bbd0-2b6b4803097b
:END:
...
:ID:       d161fd26-199b-4b3c-8c38-43766ef4fab9
:END:
*** 概要
...
*** embark
まだ活用できてないが Embark 用に ~C-;~ を bind した。
かつて Helm あたりで使っていたキーバインドだね、なつかしいね。
...
#+begin_src emacs-lisp :tangle recipes/track-changes.rcp
(:name track-changes
...
#+begin_src emacs-lisp :tangle recipes/mcp.rcp
(:name mcp
...
** yasnippet
   ...
   :ID:       75c2737a-e8e6-4048-8ebd-9722dd110e41
   :END:
...
- [[id:39a74b47-abe6-4b70-bf3d-e0bc9b5c8699][alert]] :: 共通インターフェースで色々な通知機能と連携して通知するやつ
- [[id:7a4f961b-905c-43ab-8650-db5c07af522b][all-the-icons]] :: Emacs で様々なアイコンを表示できるようにするやつ
- [[id:db648851-b38a-412b-958e-f19cb0387ad2][color-theme-molokai]] :: ダークグレーベースのカラーテーマ
- [[id:82501484-284a-4bf9-8281-e70fa5b70ac9][dashboard]] :: Emacs 起動時の表示を便利にしてくれるパッケージ
- [[id:4c2cc27d-e423-4056-b7d2-fdaef852ccc6][embark]] :: コンテキストに応じて選択できるコマンドを良い感じに提案するっぽいやつ
- [[id:fc2448fa-20f2-4cae-a0e6-863c1a4f03b7][frame-cmds]] :: フレーム移動や拡縮などの操作をするコマンド群
- [[id:98f8106a-30a2-495e-8163-a9800547e58f][fullscreen]] :: 起動時のフルスクリーン設定
- [[id:6ca20e1f-41bd-42a1-8f7d-7b43649f39a5][git-gutter-fringe]] :: 最後のコミットからどう弄ったかを fringe 領域に表示してくれるやつ
- [[id:8851fab1-125b-48fc-861f-279cd87a86b0][keypression]] :: Emacs 上でのキー操作を可視化してくれるツール。
- [[id:2f778f3d-4bdc-4966-8180-5002d23ba36c][highlight-indent-guides]] :: インデント毎にラインを引いたりして見易くしてくれるやつ
- [[id:816021af-8b84-477d-a30f-4f65ae511756][hydra]] :: サブコマンドをビジュアル的に表示してくれるメニューを提供してくれるやつ
- [[id:fcfad299-40f5-4a6f-b3e1-7babc4dc00f5][ido-mode]] :: Emacs 標準添付の補完インターフェース
- [[id:6d6a67b2-b18f-4253-98ae-fc5fca740525][ivy]] :: 絞り込みインターフェーズを提供してくれるやつ。
- [[id:909f18fe-b48d-41cd-b328-3675fbf66f7c][minimap]] :: ソースコード全体を俯瞰するためのやつ
- [[id:25611c17-8657-4004-b321-568824e05a7e][mode-line]] :: モードラインに関する設定をここにまとめている
- [[id:860d480d-a254-4814-bc93-0e530abf4523][Neotree]] :: フォルダ構造を IDE みたいにツリー表示するやつ
- [[id:3418dc21-9630-4710-8a5c-5b6bc0910ddd][posframe]] :: いい感じの位置に child frame を表示する機能を提供するやつ
- [[id:8c48a9a5-1946-4f08-9127-47747fc6affa][show-paren-mode]] :: 対応するカッコとコッカをハイライトしてくれたりするやつ
- [[id:dc3d4551-9b49-4ccd-b80e-6c2d41e5488e][toolbar]] :: Emacs 標準のボタンなどの UI 部分の設定
- [[id:62f97971-f5f5-4901-b9a6-6383cb5734f2][uniquify]] :: 同名ファイルを開いている時にどこのファイルかまで表示してくれるやつ
- [[id:f34dd82d-4824-40ea-beb4-7cf0ca9a1969][yascroll]] :: 主張の大人しいスクロールバーを表示してくれるやつ
- [[id:db6fac56-d7ca-44d6-ac4a-580fd8e069cd][zoom]] :: フォーカスが当たってるウインドウを大きく表示してくれるやつ
- [[id:0c97de56-7c3d-4755-81fe-050118187e7a][zoom-window]] :: 見ている window を最大化したり戻したりしてくれるやつ
** alert
:PROPERTIES:
:EXPORT_FILE_NAME: alert
:ID:       39a74b47-abe6-4b70-bf3d-e0bc9b5c8699
:END:
*** 概要
...
:ID:       7a4f961b-905c-43ab-8650-db5c07af522b
:END:
...
:ID:       db648851-b38a-412b-958e-f19cb0387ad2
:END:
*** 概要
...
:ID:       82501484-284a-4bf9-8281-e70fa5b70ac9
:END:
*** 概要
...
#+begin_src emacs-lisp :tangle recipes/page-break-lines.rcp
...
** embark
:PROPERTIES:
:ID:       4c2cc27d-e423-4056-b7d2-fdaef852ccc6
:EXPORT_FILE_NAME: embark
:END:
*** 概要
[[https://github.com/oantolin/embark][Embark]] は操作コンテキストに応じたコマンドを教えてくれるツール。
また expand-region のように選択しているコンテキストを広げてくれる機能もある
*** インストール
...
#+begin_src emacs-lisp :tangle inits/50-embark.el
...
help が出るようにしている。
というか ivy を導入しているので、これで ivy の絞り込みインターフェースが起動するようになっている。
...
:ID:       fc2448fa-20f2-4cae-a0e6-863c1a4f03b7
:END:
*** 概要
...
:ID:       98f8106a-30a2-495e-8163-a9800547e58f
:END:
*** 概要
...
:ID:       6ca20e1f-41bd-42a1-8f7d-7b43649f39a5
:END:
...
:ID:       8851fab1-125b-48fc-861f-279cd87a86b0
:END:
*** 概要
...
:ID:       816021af-8b84-477d-a30f-4f65ae511756
:END:
...
#+begin_src emacs-lisp :tangle snippets/emacs-lisp-mode/define-major-mode-hydra
# -*- mode: snippet -*-
...
| Key | 効果                                                                                              |
| z   | [[id:db6fac56-d7ca-44d6-ac4a-580fd8e069cd][zoom-mode]] のON/OFF切替。狭いディスプレイの時は ON にするが、大きいディスプレイだと OFF にしている |
...
| N   | [[id:860d480d-a254-4814-bc93-0e530abf4523][Neotree]] の表示切替。普段は邪魔なので OFF にしている                                               |
...
**** tab-bar-mode
:PROPERTIES:
:ID:       df394c80-2a39-4bd2-9fba-73d55983fefd
:END:
...
:END:
よく使うコマンドをまとめたやつ。
[[id:d161fd26-199b-4b3c-8c38-43766ef4fab9][key-chord]] を使って ~jk~ 同時押しで起動できるようにしている。
...
| Key | 効果                                                                      |
| p   | [[id:5db31aa2-759b-48c6-853c-6dceddfcfc8a][projectile]] 用の Hydra 起動                                                |
| f   | counsel でファイルを開く                                                  |
| d   | counsel でフォルダ開く                                                    |
...
| j   | [[id:dd88faa0-4266-4552-8d37-f38597eaf83f][dumb-jump]] 用の Hydra 起動                                                 |
| g   | 画面上の好きな位置にジャンプする [[id:78f84004-9a76-46ce-9176-6b0c0721b05e][avy]] の起動                               |
| i   | counsel-imenu 起動。使ってない気がする                                    |
| y   | [[id:75c2737a-e8e6-4048-8ebd-9722dd110e41][yasnippet]] 用の Hydra 起動                                                 |
| B   | [[id:b2f7eac2-2438-46fb-94e3-b8ff3ec23691][browse-at-remote]] で GitHub などのコード位置を開く                         |
| m   | [[id:8e0d3e97-c1b6-4e23-bd9d-9bc5c1c9b99c][magit]] を起動                                                              |
| D   | 他の Window を消す                                                        |
...
:ID:       fcfad299-40f5-4a6f-b3e1-7babc4dc00f5
:END:
*** 概要
...
:ID:       6d6a67b2-b18f-4253-98ae-fc5fca740525
:END:
*** 概要
*** インストール
:PROPERTIES:
...
#+begin_src emacs-lisp :tangle recipes/swiper.rcp
(:name swiper
...
:ID:       25611c17-8657-4004-b321-568824e05a7e
:END:
*** 概要
...
:ID:       860d480d-a254-4814-bc93-0e530abf4523
:END:
...
:ID:       3418dc21-9630-4710-8a5c-5b6bc0910ddd
:END:
*** 概要
...
:ID:       8c48a9a5-1946-4f08-9127-47747fc6affa
:END:
...
:ID:       dc3d4551-9b49-4ccd-b80e-6c2d41e5488e
:END:
...
:ID:       62f97971-f5f5-4901-b9a6-6383cb5734f2
:END:
...
:ID:       f34dd82d-4824-40ea-beb4-7cf0ca9a1969
:END:
*** 概要
...
:ID:       db6fac56-d7ca-44d6-ac4a-580fd8e069cd
:END:
...
:ID:       0c97de56-7c3d-4755-81fe-050118187e7a
:END:
...
- [[id:1049f5b1-827f-445d-abe1-d45c05a792cd][ace-window]] :: 3つ以上にウインドウを分割している際のウインドウ切替を楽にしてくれるパッケージ
- [[id:78f84004-9a76-46ce-9176-6b0c0721b05e][avy]] :: 表示されてるところの好きな場所にさくっとジャンプするためのパッケージ
- [[id:b2f7eac2-2438-46fb-94e3-b8ff3ec23691][browse-at-remote]] :: 表示している行の GitHub などのサービス上の位置でブラウザで開いてくれるパッケージ
- [[id:dd88faa0-4266-4552-8d37-f38597eaf83f][dumb-jump]] :: カーソル下の関数とかの定義場所にジャンプしてくれるパッケージ
- [[id:5db31aa2-759b-48c6-853c-6dceddfcfc8a][projectile]] :: プロジェクト内のファイルなどを開いたりするのに便利なパッケージ

** ace-window
:PROPERTIES:
:EXPORT_FILE_NAME: ace-window
:ID:       1049f5b1-827f-445d-abe1-d45c05a792cd
:END:
...
:ID:       78f84004-9a76-46ce-9176-6b0c0721b05e
:END:
...
:ID:       b2f7eac2-2438-46fb-94e3-b8ff3ec23691
:END:
...
:ID:       dd88faa0-4266-4552-8d37-f38597eaf83f
:END:
...
:ID:       5db31aa2-759b-48c6-853c-6dceddfcfc8a
:END:
...
- [[id:0d552f94-9a0e-4120-a8b1-b24f6abf8e9b][emacs-lisp]] :: Emacs Lisp を書くための設定
- [[id:e3a76e2e-d7dc-46e2-93c2-b71c40302264][Ember.js]] :: Web フロントエンド MVC フレームワークである Ember.js 用の設定を書いている
- [[id:f921d94b-9be1-4065-a767-2cc3d2cf8c01][es6]] :: ES2015 以降の JS に関する設定。es6 としているのは過去の経緯のため。
- [[id:c001bbc2-e937-4296-9791-cedb1b3b16fe][flycheck]] :: Flycheck の設定について書いている
- [[id:440a4c36-ff17-463e-9693-585d333b8cc9][gnuplot-mode]] :: グラフ作成ソフト gnuplot を使うための設定
...
- [[id:bbf27822-e221-4b5d-9602-70778c981d1a][kdl-mode]] :: KDL という設定ファイル用の言語のための major-mode の設定
- [[id:efae3643-0001-4313-a621-83517950652f][lsp-mode]] :: Emacs の LSP クライアントの一種である lsp-mode に関する設定
- [[id:d3671474-f07e-457e-8f75-28af1eab3b6a][markdown]] :: Markdown を書く時の設定
- [[id:ce65c5cf-6c2a-46d2-b000-f796063f685d][Mocha]] :: Mocha を使ったテストを動かすための設定
- [[id:4adda184-78ad-44fa-a0b2-01389e3f33db][plantuml-mode]] :: PlantUML を書く時のメジャーモードの設定
- [[id:d0163a62-b490-44b0-b581-4bd51cd976c3][rails]] :: Rails 開発をする上での設定
- [[id:8ad6fdb1-71c6-4f8e-815d-1101b8eeb53d][React.js]] :: React.js アプリを開発するための設定
- [[id:efc3f180-6860-4925-80f2-931cdfbe7913][rspec-mode]] :: Ruby のテストフレームワーク RSpec を書いたりするのに便利なモード
- [[id:dac5d600-f72c-4e4b-8d58-c7c8ce72589d][ruby]] :: Ruby を書く上での設定
- [[id:7730bf6e-8c15-4265-847b-cad7f4d14e17][scss]] :: SCSS を書く上での設定
...
- [[id:51003168-6cfc-4154-8283-26452d7d0960][TypeScript]] :: TypeScript を書く上での設定
- [[id:e1df9ee3-8044-4001-8b68-85bf94cb58a6][Vue.js]] :: Vue.js を書く上での設定
- [[id:21cc341d-0f35-438e-9f1c-a430592b605c][yaml-mode]] :: YAML を書く時のメジャーモードの設定
** Docker
:PROPERTIES:
...
:ID:       0d552f94-9a0e-4120-a8b1-b24f6abf8e9b
:END:
*** 概要
Emacs Lisp を書くための設定。
...
:ID:       e3a76e2e-d7dc-46e2-93c2-b71c40302264
:END:
...
:ID:       f921d94b-9be1-4065-a767-2cc3d2cf8c01
:END:
...
:ID:       440a4c36-ff17-463e-9693-585d333b8cc9
:END:
*** 概要
...
** Go言語
:PROPERTIES:
:ID:       633b7e2c-2920-4614-aeee-e4c3f56ac59e
:EXPORT_FILE_NAME: golang
:END:
*** go-mode
**** 概要
[[https://github.com/dominikh/go-mode.el][go-mode]] はGo言語の記述を補助するメジャーモード
**** インストール
el-get 本体にレシピがあるのでそれをそのまま利用して
el-get-bundle でインストールしている

#+begin_src emacs-lisp :tangle inits/40-go.el
...
** kdl-mode
:PROPERTIES:
:EXPORT_FILE_NAME: kdl-mode
:ID:       bbf27822-e221-4b5d-9602-70778c981d1a
:END:
*** 概要
[[https://github.com/emacsmirror/kdl-mode][kdl-mode]] は [[https://kdl.dev/][KDL]] というコンフィグ用言語向けの major-mode
[[https://zellij.dev/][zellij]] の設定ファイルが KDL で書かれているので

*** インストール
ひとまず recipe を自前で用意している
#+begin_src emacs-lisp :tangle recipes/kdl.rcp
(:name kdl-mode
...
#+begin_src emacs-lisp :tangle inits/40-kdl.el
...
:ID:       d3671474-f07e-457e-8f75-28af1eab3b6a
:END:
...
:ID:       4adda184-78ad-44fa-a0b2-01389e3f33db
:END:
...
** protobuf
:PROPERTIES:
:EXPORT_FILE_NAME: protobuf
:END:
*** protobuf-mode
**** 概要
[[https://github.com/emacsmirror/protobuf-mode][protobuf-mode]] は protobuf のファイルを編集する時用のメジャーモード
**** インストール
el-get 本体にレシピがあるのでそれをそのまま利用して
el-get-bundle でインストールしている

#+begin_src emacs-lisp :tangle inits/40-protobuf.el
(el-get-bundle protobuf-mode)
#+end_src
** rails
:PROPERTIES:
:EXPORT_FILE_NAME: rails
:ID:       d0163a62-b490-44b0-b581-4bd51cd976c3
:END:
*** 概要
...
ファイルナビゲーションには [[id:5db31aa2-759b-48c6-853c-6dceddfcfc8a][projectile]] の拡張である [[https://github.com/asok/projectile-rails][projectile-rails]] を利用している。
...
:ID:       8ad6fdb1-71c6-4f8e-815d-1101b8eeb53d
:END:
*** 概要
...
:ID:       dac5d600-f72c-4e4b-8d58-c7c8ce72589d
:END:
*** 概要
...
:ID:       7730bf6e-8c15-4265-847b-cad7f4d14e17
:END:
*** 概要
...
#+begin_src emacs-lisp :tangle recipes/reformatter.rcp
(:name reformatter
...
:END:
*** 概要
[[https://github.com/leafOfTree/svelte-mode][svelte-mode]] は [[https://svelte.jp/][Svelte]] を書く時に使う major-mode
*** インストール
el-get 本体にはレシピがないので自前で用意している。

#+begin_src emacs-lisp :tangle recipes/svelte-mode.rcp
(:name svelte-mode
...
#+begin_src emacs-lisp :tangle inits/40-svelte.el
...
:ID:       51003168-6cfc-4154-8283-26452d7d0960
:END:
*** 概要
...
:ID:       e1df9ee3-8044-4001-8b68-85bf94cb58a6
:END:
*** 概要
...
:ID:       21cc341d-0f35-438e-9f1c-a430592b605c
:END:
*** 概要
...
- [[id:f4971222-a485-42ab-9035-26c5724a64ff][aidermacs]] :: AI とのペアプロをするためのツールと連携するやつ
...
- [[id:ee19947b-da94-424b-8844-74ca5185a452][claude-code.el]] :: ClaudeCode と連携するためのパッケージ
- [[id:69f9c15d-05f9-4efc-8ff8-5cacccce75a8][emacs-kibela]] :: Emacs から Kibela に記事を書いたりするためのパッケージ
- [[id:e141c62d-fbdc-4129-ac55-043366632213][emacs-w3m]] :: 和製テキストブラウザである w3m を Emacs で使えるようにするパッケージ
- [[id:6cdbff91-2870-4630-962c-6a35906a9db7][engine-mode]] :: Emacs からささっと色々な検索エンジンで検索できるようにするパッケージ
- [[id:13087648-d09a-4754-bf5d-27359c0863f3][esa.el]] ::  [[https://esa.io/][esa.io]] と連携するためのパッケージ
- [[id:c01f3fef-7ac0-4f80-946d-3d74647defd9][forge]] :: [[*magit][magit]] と GitHub を連携して Emacs 上で PR を眺めたりできるようにするパッケージ
- [[id:ce83e9b8-ef96-4a27-bcfb-a2b437ca5a28][git-messenger]] :: 現在の行の最終コミットの情報を表示してくれるパッケージ
- [[id:ce8bc262-0fd2-4a0f-aa19-da7ad3f15894][google-this]] :: Google 検索機能を提供してくれるパッケージ
- [[id:0416ccf6-f302-4713-8465-6bed9c38b839][google-translate]] :: Emacs から Google 翻訳するためのパッケージ
- [[id:8e0d3e97-c1b6-4e23-bd9d-9bc5c1c9b99c][magit]] :: Emacs 上で Git の操作をするのにとても便利なパッケージ
- [[id:4ae25e08-de4a-42c0-90e6-f39cc7cd0cb2][mistty]] :: Emacs 上で動く terminal の一種
- [[id:fb57863f-227d-4c8a-86d9-9547ec92ca17][mu4e]] :: Emacs 上で動くメーラー
- [[id:b8f02a8e-f6f8-4c44-b821-392ff4cb1f7d][notify-slack]] :: Emacs から外部コマンドを通じて Slack に通知するための関数周りの事を書いている
...
- [[id:ff301b66-6de6-4b70-9abb-5776f2e1a646][todoist]] :: Todoist と連携して org-mode で扱えるようにするパッケージ
- [[id:e0a77ea3-429c-4f0d-8caf-7fde52a3b3a3][twmode]] :: Emacs 上で動く Twitter クライアント
- [[id:642d7e7c-a353-4233-b62a-2ee4d7d91127][vterm]] :: Emacs 上で libvterm を動かすためのパッケージ
- [[id:9c9bff02-7627-44ae-9868-e1310ff19294][wakatime-mode]] :: Emacs と WakaTime を連携してどのプロジェクトの作業をどのぐらいしてたかを計測するパッケージ
- [[id:0b6e71ab-1fa2-4566-90b1-949842726f22][ブラウザ設定]] :: ブラウザ連携周りの設定
** aidermacs
:PROPERTIES:
:ID:       f4971222-a485-42ab-9035-26c5724a64ff
:EXPORT_FILE_NAME: aidermacs
:END:
*** 概要
[[https://github.com/MatthewZMD/aidermacs][aidermacs]] は Emacs 上で [[https://github.com/Aider-AI/aider][Aider]] とやりとりするためのパッケージ。
Aider は AI ペアプロをするためのツールで、それとのやりとりを Emacs 上でできるようにしてくれるやつ
*** インストール
el-get にはレシピがないので自前で用意している

#+begin_src emacs-lisp :tangle recipes/aidermacs.rcp
( :name aidermacs
...
** claude-code.el
:PROPERTIES:
:EXPORT_FILE_NAME: claude-code
:ID:       ee19947b-da94-424b-8844-74ca5185a452
:END:
*** 概要
[[https://github.com/stevemolitor/claude-code.el][claude-code.el]] は [[https://docs.anthropic.com/en/docs/claude-code/overview][Claude Code]] と連携するためのパッケージ。
...
#+begin_src emacs-lisp :tangle recipes/emacs-eat.rcp
( :name emacs-eat
...
#+begin_src emacs-lisp :tangle recipes/inheritenv.rcp
(:name inheritenv
...
#+begin_src emacs-lisp :tangle recipes/claude-code.rcp
( :name claude-code
...
#+begin_src emacs-lisp :tangle inits/50-claude-code.el
...
:ID:       13087648-d09a-4754-bf5d-27359c0863f3
:END:
*** 概要
...
:ID:       ce8bc262-0fd2-4a0f-aa19-da7ad3f15894
:END:
*** 概要
...
:ID:       0416ccf6-f302-4713-8465-6bed9c38b839
:END:
*** 概要
...
:ID:       8e0d3e97-c1b6-4e23-bd9d-9bc5c1c9b99c
:END:
*** 概要
...
#+begin_src emacs-lisp :tangle recipes/cond-let.rcp
(:name cond-let
...
** mu4e
:PROPERTIES:
:ID:       fb57863f-227d-4c8a-86d9-9547ec92ca17
:EXPORT_FILE_NAME: mu4e
:END:
*** 概要
mu4e は [[https://github.com/djcb/mu][mu]] の一部で、一緒に使うことで Emacs でメールを扱えるようになるパッケージです。
*** インストール
こちらは aur にある mu をインストールして
そこにある mu4e の path を通して利用しています。
...
で入れました。
これで ~/usr/share/emacs/site-lisp/mu4e~ に mu4e が入るので load-path も問題なく通っていました
*** 設定
**** 読み込み
load-path は通っているので require するだけで OK

#+begin_src emacs-lisp :tangle inits/70-mu4e.el
(require 'mu4e)
#+end_src
**** username/password 取得用の関数定義
...
- mu4e-root-maildir :: メールの保存先ディレクトリ
- mu4e-get-mail-command :: offlineimap のコマンド。mu4e はメールの取得に offlineimap を使うのでそれを指定する。
- mu4e-update-interval :: 10分ごとにメールを取得するように設定
- mu4e-notification-support :: 新着メールがあれば通知されるように設定
...
:ID:       b8f02a8e-f6f8-4c44-b821-392ff4cb1f7d
:END:
*** 概要
...
:ID:       ff301b66-6de6-4b70-9abb-5776f2e1a646
:END:
*** 概要
...
:ID:       e0a77ea3-429c-4f0d-8caf-7fde52a3b3a3
:END:
*** 概要
...
** vterm
:PROPERTIES:
:ID:       642d7e7c-a353-4233-b62a-2ee4d7d91127
:EXPORT_FILE_NAME: vterm
:END:
*** 概要
[[https://github.com/akermu/emacs-libvterm][vterm]] は Emacs 上で libvterm をベースにした端末エミュレータ。
*** インストール
el-get 本体にレシピがあるのでそれを使って ~el-get-bundle~ でインストールしている

#+begin_src emacs-lisp :tangle inits/40-vterm.el
(el-get-bundle vterm)
#+end_src
** wakatime-mode
:PROPERTIES:
...
:ID:       667ced55-6216-4f55-aa87-3a0c64c56341
:END:

ここでは org-mode 周りの設定をまとめている。
org-mode だけでも書くことが多いからね……。

1. [[id:dd72db58-58b4-4b92-a817-54f8bd0d5244][基本設定]]
2. [[id:7eec3f52-cffc-4779-9dd9-c4d895236c87][org-babel]]
3. [[id:f17c246c-e0ee-47b3-b3da-04ac8872f9b8][予定のカレンダー表示]]
4. [[id:9b4dc27f-7b3b-4292-9f0b-2149666585f6][Agenda 関係の設定]]
5. [[id:ce99e560-beff-4846-b84d-e0f5fe4c20e5][org-capture]]
6. [[id:a9fde2f5-163f-437f-9f78-56f69f81cf12][org-protocol-capture-html]]
7. [[id:90a15747-ebaa-436a-9145-8d2277f7c9ca][org-clock]]
8. [[id:1316fced-bd70-481a-a8db-93100a2fc8e4][org-export]]
9. [[id:4dd5f92b-a7f4-4245-b91c-a5154cf14c0f][org-gcal]]
10. [[id:0b73e981-5902-472e-91ab-ac528c69c1bd][org-ql]]
11. [[id:827fac53-3b4b-420d-9adf-037496eec37a][org-refile]]
12. [[id:72eb002f-ce8c-4a80-ad68-edfc9681864e][org-trello]]
13. [[id:917c0e2f-5091-4fb3-bf22-cfa2c071f709][ox-hugo]]
14. [[id:e2943058-f0e2-4e6f-ba27-89ab3ec6f05e][org-roam]]
15. [[id:24451bfc-9576-49aa-9631-90f068618580][ox-nippou]]
16. [[id:c96e37d7-2c93-48f6-a612-04f8b1001b0e][org-mode 用の独自コマンド]]
17. [[id:b4575c67-6d15-40ad-9624-a18854ea2c4e][org-mode 関係の keybinds]]
18. [[id:8efc5c01-6d70-4ce5-b363-7449c6da6bae][日報用の設定(旧)]]
** 基本設定
:PROPERTIES:
:EXPORT_FILE_NAME: base
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :weight 1
:CUSTOM_ID: org-mode-base-config
:ID:       dd72db58-58b4-4b92-a817-54f8bd0d5244
:END:
*** 概要
...
:ID:       7eec3f52-cffc-4779-9dd9-c4d895236c87
:END:
*** 概要
...
:ID:       f17c246c-e0ee-47b3-b3da-04ac8872f9b8
:END:
*** 概要
...
:ID:       9b4dc27f-7b3b-4292-9f0b-2149666585f6
:END:
*** 概要
...
#+end_src
****** 休日開始用 agenda
[[id:8a755cca-6e59-40d2-bfe2-5b8df1a85a9c][休日の定例用 agenda]] でまとめて出て来るのが嫌になったので
休日の最初に見る agenda を分離してみた。
...
****** 休日の定例用 agenda
:PROPERTIES:
:ID:       8a755cca-6e59-40d2-bfe2-5b8df1a85a9c
:END:
...
:ID:       ce99e560-beff-4846-b84d-e0f5fe4c20e5
:END:
*** 概要
...
:ID:       90a15747-ebaa-436a-9145-8d2277f7c9ca
:END:
*** 概要
...
:ID:       1316fced-bd70-481a-a8db-93100a2fc8e4
:END:
*** 概要
...
:ID:       4dd5f92b-a7f4-4245-b91c-a5154cf14c0f
:END:
*** 概要
...
#+begin_src emacs-lisp :tangle recipes/emacs-oauth2-auto.rcp
...
:END:
通知には [[id:39a74b47-abe6-4b70-bf3d-e0bc9b5c8699][alert]] を使いたいので自前で関数を定義。
...
:ID:       0b73e981-5902-472e-91ab-ac528c69c1bd
:END:
...
:ID:       827fac53-3b4b-420d-9adf-037496eec37a
:END:
*** 概要
...
:ID:       72eb002f-ce8c-4a80-ad68-edfc9681864e
:END:
*** 概要
...
:ID:       917c0e2f-5091-4fb3-bf22-cfa2c071f709
:END:
...
** ox-nippou
:PROPERTIES:
:ID:       24451bfc-9576-49aa-9631-90f068618580
:EXPORT_FILE_NAME: ox-nippou
:END:
*** 概要
[[https://github.com/mugijiru/ox-nippou][ox-nippou]] は org-mode のファイルから日報を出力するための自作パッケージです。
*** インストール
自作パッケージなので自前で el-get 用にレシピを用意している

#+begin_src emacs-lisp :tangle recipes/ox-nippou.rcp
( :name ox-nippou
...
#+begin_src emacs-lisp :tangle inits/66-ox-nippou.el
...
:ID:       c96e37d7-2c93-48f6-a612-04f8b1001b0e
:END:
...
:ID:       b4575c67-6d15-40ad-9624-a18854ea2c4e
:END:
*** 概要
...
:ID:       8efc5c01-6d70-4ce5-b363-7449c6da6bae
:END:
*** 概要
業務で日報を提出する必要があったので
それっぽいのを作れるようにしていた。
