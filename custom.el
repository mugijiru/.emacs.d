(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (gnu-elpa-keyring-update ivy dumb-jump gnuplot hide-mode-line oauth2 zoom rainbow-mode molokai-theme xml-rpc vue-html-mode ssass-mode edit-indirect ember-mode)))
